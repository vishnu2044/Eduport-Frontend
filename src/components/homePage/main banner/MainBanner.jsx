        ...
        <div className="container items-center max-w-6xl px-8 mx-auto xl:px-5">
            ...
            <div className="w-full md:w-1/2 md:px-3">
                ...
                <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                    <span className="block xl:inline">Innovative Tools for</span>
                    <span className="block text-indigo-600 xl:inline">Mastering Online Learning.</span>
                </h1>
                <p className="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">Unlock your potential with our cutting-edge platform designed to enhance your learning experience and accelerate your growth.</p>
